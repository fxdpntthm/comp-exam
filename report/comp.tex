...
intermediate language. In the next section we go over more language feature extensions. While
...
% typechecker to resolve it to a specific instance.
% Constraint handling
% rules~\cite{fruhwirth_theory_1998,stuckey_theory_2005} accounts for operator overloading.
% The limitation of using CHRs is that the programmer needs to ensure confluence external to the
