...
\TODO{How does adding kind equality change the operational semantics of the language? the coercions should not interfere with the push rule}
...
%%%%%%%%%
\subsection{Typeclasses}\label{sec:rw-typeclasses}
