...
compiler. Mathematically, typeclasses can also be viewed as relations
over types\cite{morris_simple_2014} where, every instance declaration
extends that relation. The typeclass !Num! represents a unary relation
