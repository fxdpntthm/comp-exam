...
\begin{figure}[ht]
  \centering
  \begin{syntax}
    \text{Type Vars} &\alpha,\beta,\Co  &\qquad\text{Type constants} &T \\
  ...
  \begin{syntax}
    ...
    \end{syntax}
    \begin{syntax}
    \text{Typing Context} &&\TEnv,\Delta \bnfeq& \empt \bnfor \TEnv,x\co\tau \bnfor \TEnv,\alpha\co\kappa \bnfor \TEnv,H\co T \bnfor \TEnv, \Co \co \tau\sim\sigma\\
...
\newcommand\KInstCo{
  \ib{\irule[\trule{co-$\E\forall$}]
    {\CoKinding\TEnv \Co {\Forall\alpha\tau_1 \sim \Forall\beta\tau_2}}
...
\newcommand\KForallCo{
  \ib{\irule[\trule{co-$\I\forall$}]
    {\CoKinding {\TEnv,\alpha\co\kappa} \Co {\tau_1 \sim \tau_2}}{\alpha \# \TEnv};
    {\CoKinding \TEnv {\Forall {\alpha\co\kappa} \Co} {\Forall {\alpha\co\kappa}\tau_1 \sim \Forall {\alpha\co\kappa}\tau_2}}
  }
}
...
\begin{figure}[h]
  ...
  \begin{syntax}
    ...
    \text{Type Vars} &\alpha,\beta,\Co  &\qquad\text{Type constants} &T,\shl{H} \\
    \text{Term Vars} &x,y                  &\qquad\text{Indices}        &i,n \in \mathbb{N} \\
    \text{Coercion Vars} &c & &
  \end{syntax}
  \begin{syntax}
    ...
    \text{Types}     &&\tau,\sigma  \bnfeq& \alpha \bnfor T \bnfor \tau \to \tau \bnfor \tau\App\tau \bnfor \Forall {\alpha\co\kappa} \tau \bnfor F_n \bnfor \shl{\Forall \chi \tau} \bnfor \shl{\tau\App\kappa} \bnfor \shl{H}\\
    \text{Coercions} &&\nu,\Co      \bnfeq& c \bnfor \refl\tau \bnfor \Sym\Co \bnfor \trans\nu\Co % equiv relation
                                      \bnfor \Forall {\alpha\co\kappa} \Co \bnfor \Co\At\tau % abstraction instanst
                                      \bnfor \nu\App\Co \bnfor \Left \Co \bnfor \Right \Co  % compose/decompose
    ...
    \text{Patterns}  &&P    \bnfeq& H\App\shl{\many\chi}\App\many{\alpha\co\kappa}\App{\many{x\co\tau}} \\
    \text{Terms}     &&M,N  \bnfeq& x \bnfor  \Lam {x\co\tau} M \bnfor M\App N \bnfor \TLam{\tau\co\kappa} M \bnfor M\App \tau \bnfor H \bnfor \Case M \many{P \to M} \bnfor \Cast \Tm \Co %
...
\begin{figure}[ht]
  ...
  \begin{syntax}
    ...
    \text{Types and Kinds}     &&\tau,\sigma,\kappa   \bnfeq& w \bnfor \tau\App\tau %
                                                       \bnfor \Forall {\alpha\co\kappa} \tau \bnfor %
    ...
    \text{Coercions}    &&\MCo,\Co   \bnfeq& c \bnfor \refl\tau \bnfor \Sym\Co \bnfor \trans\MCo\Co \\ % equiv relation
                        && & \bnfor\shl{\ForallC {\MCo} {(\alpha_1, \alpha_2, c)} \Co} \bnfor \shl{ \MCo\App(\Co, \Co')} %
                                        ...
                                        \bnfor \nth i \Co \bnfor \shl{\Kind \Co} \bnfor T\App\many\phi \\  % compose/decompose
    \text{Types/Coercions} && \phi \bnfeq& \tau \bnfor \Co\\
    \text{Patterns}  &&P    \bnfeq& H\App \shl{\many{\Telescope}}\App{\many{x\co\tau}} \\
    \text{Telescopes} &&\Telescope \bnfeq& \empt \bnfor \Telescope, \alpha\co\kappa \bnfor \Telescope, c\co\Prop\\
...
\newcommand\KCAllT{
  \ib{\irule[\trule{co-$\I{\forall\tau}$}] 
    {\LARGE\substack{ {\CoKinding {\TEnv,\alpha\co\kappa,\alpha'\co\kappa',c\co\alpha\sim\alpha'} {\Co} {\tau\sim\tau'}}\\
      {\Kinding \TEnv {\Forall {\alpha\co\kappa} {\tau}} {\star}}}}
    {\LARGE\substack{ {\CoKinding \TEnv \MCo {\kappa\sim\kappa'}}\\
      {\Kinding \TEnv {\Forall {\alpha'\co\kappa'} {\tau'}} {\star}}}};
    {\CoKinding \TEnv {\ForallC\MCo{(\alpha,\alpha',c){\Co}}} {\Forall {\alpha\co\kappa}{\tau} \sim \Forall {\alpha'\co\kappa'}{\tau'}}}
  }
}
...
\newcommand\KCAllC{
  \ib{\irule[\trule{co-$\I{\forall\Co}$}] 
    {\CoKinding \TEnv {\Co} {\tau_1 \App \sigma_1 \sim \tau_2 \App \sigma_2}};
    {\CoKinding \TEnv {\ForallC{(\MCo,\MCo')}{(c, c'){\Co}}} {\Forall {c\co\Prop}{\tau} \sim \Forall {c'\co\Prop'}{\tau'}}}
  }
 }
