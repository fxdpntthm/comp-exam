...
\AI{Existential types can be encoded in \SF already. The key point to illustrate is Henry ford encoding aka type equalities}
...
The proof of progress does not change with respect to \SFC as the only additional construct is roles, which does not play any part in the operational semantics of the language. The proof of preservation uses the formulation of role directed coercion calculus and thus requires some attention.
