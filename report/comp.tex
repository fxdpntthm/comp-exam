...
\newcommand\GADTAlt{
  \ib{\irule[\trule{g-alt}]
    {\LARGE\substack{
        {H\co \Forall {\many\TyVar} {\Forall {\many\beta} {\many{\tau'\sim\tau''} \then \many\tau \to T\many\TyVar}}}\quad
        {\many\TyVar \cap \many\beta = \varnothing}\quad
        {\fvs{\many\tau, \many{\tau'}, \many{\tau''}} = \fvs{\many\TyVar, \many\beta}}\quad
        {\Subst = \Set{\many{\TyVar\mapsto v}}}\quad
        {\fresh {\many{c}} {C, \TEnv}}\\
...
\newcommand\KCAllT{
  \ib{\irule[\trule{co-$\I{\forall\tau}$}]
    {\LARGE\substack{ {\CoKinding {\TEnv,\TyVar\co\kappa,\TyVar'\co\kappa',c\co\TyVar\sim\TyVar'} {\Co} {\tau\sim\tau'}}\\
      {\Kinding \TEnv {\Forall {\TyVar\co\kappa} {\tau}} {\star}}}}
...
\newcommand\KCAllC{
  \ib{\irule[\trule{co-$\I{\forall\Co}$}]
    {\LARGE\substack{{\CoKinding {\TEnv,c\co\Prop,c'\co\Prop'} {\Co} {\tau\sim\tau'}} \\
                     {\Kinding \TEnv {\Forall {c\co\Prop} {\tau}} \star}%
                     ~~{\Kinding \TEnv {\Forall {c'\co\Prop'} {\tau'}} \star}
                        }}
    {\fresh {\Set{c, c'}}{\Erased\Co}}
    {\LARGE\substack{{\CoKinding \TEnv {\MCo_1} {\sigma_1 \sim \sigma_1'}}\\
                  {\CoKinding \TEnv {\MCo_2} {\sigma_2 \sim \sigma_2'} }}}
    {\LARGE\substack{{p = \sigma_1\sim\sigma_2}\\
                     {p' = \sigma_1'\sim\sigma_2'}}};
