...
Certain functions behave uniformly on the data that they might receive. An archetypical example is that of an identity function $id$ that just takes an value and returns it untouched.
\begin{code}
  id : FORALL a. a -> a
  id a = a
\end{code}
Such functions are said to be parametric polymorphic over their type arguments\cite{strachey_fundamental_2000}. 
