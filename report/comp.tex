...
\begin{abstract}
  ...
  era. Computers are increasingly being used to assist us in all of our
  day to day activities by automating a wide variety of tasks in
  different areas from transportation, communication, finance and
  energy, to education, entertainment and art. To accomplish these tasks, computers run
  software. The omnipresent nature of software
  makes it mission critical; human lives and financial capital may
  depend on it. This warrants efficient and unambiguous communication
  with computers. Programming languages are the interface between humans and
  computers and thus, it is necessary to understand the principles of
  ...
  programming language. It identifies and studies some
  key language features, which when used to write programs provides
  machine verified guarantees by following the footsteps of ``correct by
